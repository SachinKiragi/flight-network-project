...
//TEMPRORY FLIGHTS ARRAY USED TO PROVIDE ALL FLIGHTS FROM S -> D IN INCEASING ORDER OF COST
 flights* tempFlightsFromSourceToDest = NULL;
...
void heading() {
    printf("\t _____ _            _   _                              \n");
    printf("\t/  ___| |          | | | |                             \n");
    printf("\t\\ `--.| | ___   _  | | | | ___  _   _  __ _  __ _  ___ \n");
    printf("\t --. \\ |/ / | | | | | | |/ _ \\| | | |/ _ |/ _` |/ _ \\\n");
    printf("\t/\\__/ /   <| |_| | \\ \\_/ / (_) | |_| | (_| | (_| |  __/\n");
    printf("\t\\____/|_|\\_\\\\__, |  \\___/ \\___/ \\__, |\\__,_|\\__, |\\___|\n");
    printf("\t             __/ |               __/ |       __/ |     \n");
    printf("\t            |___/               |___/       |___/      \n");
    printf("\n");
...
void addPlaces(){
    ...
    noOfPlaces++;
    strcat(places[9], "tokyo");
    noOfPlaces++;
    strcat(places[10], "jaipur");
    noOfPlaces++;
    strcat(places[11], "tripura");
    noOfPlaces++;
    strcat(places[12], "cochin");
    noOfPlaces++;
    strcat(places[13], "shimla");
    noOfPlaces++;
    strcat(places[14], "jammu");
    noOfPlaces++;
    strcat(places[15], "belagavi");
    noOfPlaces++;
...
void formConnectionBetweenPlaces(){
    ...
    addEdge(findKeyForString("mumbai"), findKeyForString("bengaluru"), 2);
    ...
    addEdge(findKeyForString("indore"), findKeyForString("pune"), 2);
    addEdge(findKeyForString("indore"), findKeyForString("assam"), 7);
    addEdge(findKeyForString("assam"), findKeyForString("pune"), 1);
    ...
    addEdge(findKeyForString("bengaluru"), findKeyForString("tokyo"), 12);
    addEdge(findKeyForString("tokyo"), findKeyForString("bengaluru"), 12);
    addEdge(findKeyForString("jaipur"), findKeyForString("assam"), 7);
    addEdge(findKeyForString("assam"), findKeyForString("jaipur"), 7);
    addEdge(findKeyForString("jaipur"), findKeyForString("pune"), 5);
    addEdge(findKeyForString("pune"), findKeyForString("tripura"), 5);
    addEdge(findKeyForString("tripura"), findKeyForString("indore"), 4);
    addEdge(findKeyForString("delhi"), findKeyForString("cochin"), 6);
    addEdge(findKeyForString("cochin"), findKeyForString("delhi"), 6);
    addEdge(findKeyForString("jaipur"), findKeyForString("shimla"), 3);
    addEdge(findKeyForString("shimla"), findKeyForString("jaipur"), 3);
    addEdge(findKeyForString("delhi"), findKeyForString("jammu"), 4);
    addEdge(findKeyForString("jammu"), findKeyForString("pune"), 7);
    addEdge(findKeyForString("belagavi"), findKeyForString("bengaluru"), 2);
    addEdge(findKeyForString("bengaluru"), findKeyForString("belagavi"), 2);
...
void shortest_cost_from_source_to_des_w_r_t_cost(){
    ...
    if(u==-1 || v==-1){
        printf("\nSorry! There is no Flight available from %s -> %s\n", source_name, dest_name);
        sleep(2);
        system("cls");
        return;
    }
...
int searchForFlight(int source, int dest){
    ...
    while(firstOcc>=0 && firstOcc < noOfFlights && flight[firstOcc].from == source && flight[firstOcc].to == dest){
...
void bookFlight(){
    ...
    if(flight_id>=noOfFlights || flight[flight_id].from!=source || flight[flight_id].to!=dest){
        system("cls");
        printf("You have entered wrong choice please\nEnter valid choice\n");
        sleep(3);
        goto id_input;
    }
...
int main(){
    ...
    addPlaces();
    formConnectionBetweenPlaces();
    tempFlightsFromSourceToDest = (flights*)malloc(sizeof(flights)*N);
